...
def evaluate(user_id):
    ...
    with open('/home/ubuntu/MRAC/MRACQAV1/user_data/test.pickle', 'wb') as handle:
...
def addxp(user_id, k=3, multiplier=1, identifier='experience'):
    ...
    with open('/home/ubuntu/MRAC/MRACQAV1/user_data/ranker.pickle', 'wb') as handle:
...
async def add_role(ctx, rolecode):
    ...
    print(type(memberid))
    guild = bot.get_guild(849594303784681473)
...
async def on_ready():
    ...
    try:
        with open('/home/ubuntu/MRAC/MRACQAV1/user_data/ratings.pickle', 'rb') as handle:
            ratings_history = pickle.load(handle)
    except:
        request_history = {}
    try:
        with open('/home/ubuntu/MRAC/MRACQAV1/user_data/support.pickle', 'rb') as handle:
            request_history = pickle.load(handle)
        with open('/home/ubuntu/MRAC/MRACQAV1/user_data/context.pickle', 'rb') as handle:
        ...
        print('FAILURE')
    try:
        with open('/home/ubuntu/MRAC/MRACQAV1/user_data/test.pickle', 'rb') as handle:
            test_history = pickle.load(handle)
    except:
        test_history = {}
        print('FAILURE')
    try:
        with open('/home/ubuntu/MRAC/MRACQAV1/user_data/ranker.pickle', 'rb') as handle:
    ...
    guild = bot.get_guild(849594303784681473)
    print(type(guild))
    print(type(await guild.fetch_member(849593458083627088)))
...
async def quiz(ctx, topic):
    ...
    if (user_id in test_history.keys()):
        ...
        doc = "/home/ubuntu/MRAC/MRACQAV1/NLP/" + docname[0]
...
async def on_message(message):
    ...
    if (user_id in contextual_memory.keys()):
        ...
        if (q == "support"):
            ...
            boss = await bot.fetch_user("849593458083627088")
            name = user.name
            ...
            with open('/home/ubuntu/MRAC/MRACQAV1/user_data/support.pickle', 'wb') as handle:
        ...
        if (q == 'documents' or q == 'docs' or q == 'Documents' or q == 'Docs'):
            ...
            for i in range(len(documents)):
                ...
                path = documents[i]
                print(path)
                output = "/home/ubuntu/MRAC/MRACQAV1/documents/file" + \
                    str(i+1) + ".txt"
                ...
                with open(output) as file:
                    with open("/home/ubuntu/MRAC/MRACQAV1/documents/file" + str(i+1) + ".html", "w") as output:
                        file = file.read()
                        file = file.replace("\n", "<br>")
                        output.write(file)

                to_write = "/home/ubuntu/MRAC/MRACQAV1/documents/FILE" + \
                    str(i + 1) + ".pdf"
                pdfkit.from_file(
                    "/home/ubuntu/MRAC/MRACQAV1/documents/file" + str(i+1) + ".html", to_write)
        ...
        with open('/home/ubuntu/MRAC/MRACQAV1/user_data/context.pickle', 'wb') as handle:
...
bot.run('ODUxNDc4OTUyNDAwOTEyNDE0.YL43kQ.ddNXqOXpAy_Cuv6f7YiI9rQz0Ew')
